...
export default function DeleteFormModal({userId, userName, closeEvent} : DeleteFormModalProps) {
  return (
    <ModalBackground>
      <Card className="w-full max-w-lg mx-4 border-0 shadow-lg">
        ...
        <CardContent className="space-y-4 pt-0">
          <div className="text-center space-y-2">
            <p className="text-lg text-muted-foreground">¿Está seguro que desea eliminar a este elemento?</p>
