...
export const enviarCoreoACliente = async (cuerpo: any) => {
    ...
    try {
        ...
        <p>Nos complace compartir contigo una propuesta comercial que hemos preparado específicamente para <strong>${cuerpo.organizacion}</strong>. Creemos que nuestros servicios pueden ser de gran valor para sus necesidades.</p>
        ...
        <p>Agradezco su atención y espero poder colaborar con su organizacion pronto.</p>
