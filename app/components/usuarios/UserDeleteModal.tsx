...
const deleteContact = (userId: any) => {

}

export default function UserDeleteModal({userId, userName, closeEvent} : DeleteFormModalProps) {
  return (
    <ModalBackground>
      <Card className="w-full max-w-lg mx-4 border-0 shadow-lg">
        ...
        <CardFooter className="flex justify-end space-x-4 pt-6">
          ...
          <Button variant="destructive" onClick={(userId) => { deleteContact(userId) }}>
            Eliminar
          </Button>
        </CardFooter>
      </Card>
