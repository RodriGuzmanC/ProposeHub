...
const deleteContact = (orgId: any) => {

}

export default function OrgDeleteModal({orgId, userName, closeEvent} : DeleteFormModalProps) {
  return (
    <ModalBackground>
      <Card className="w-full max-w-lg mx-4 border-0 shadow-lg">
        ...
        <CardFooter className="flex justify-end space-x-4 pt-6">
          ...
          <Button variant="destructive" onClick={(orgId) => { deleteContact(orgId) }}>
            Eliminar
          </Button>
        </CardFooter>
      </Card>
